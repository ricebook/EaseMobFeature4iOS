...
- (void)setMessageModel:(MessageModel *)model
{
    ...
    if ([_bubbleView isMemberOfClass:[EMChatTextBubbleView class]]) {
        EMChatTextBubbleView *textBubbleView = (EMChatTextBubbleView *)_bubbleView;
        if (self.messageModel.isSender) {
            textBubbleView.textLabel.textColor = [UIColor whiteColor];
        }else {
            textBubbleView.textLabel.textColor = [UIColor colorWithRed:44/255 green:48/255 blue:56/255 alpha:1];
        }
    }
}
